...
$LANG['OPEN_KEY'] = 'Abrir Clave de Symbiota';
...
$LANG['NUMBER_PENDING'] = 'Número de especímenes pendientes de protección';
$LANG['PROTECT_LOCALITY'] = 'Proteger localidades';
$LANG['CHECK_STATUS'] = 'Comprobar estado';
$LANG['EXCLUSION_LIST'] = 'Lista de Especies de Exclusión para';
$LANG['INCLUDE_TAXA'] = 'Incluye taxa de las siguientes listas';
$LANG['TAXA_EXCLUDED'] = 'Taxa excluidos explícitamente';
$LANG['AUTHORS'] = 'Autores';
$LANG['MOREDETAILS'] = 'mas detalles';
$LANG['LESSDETAILS'] = 'menos detalles';
$LANG['CITATION'] = 'Publicación';
$LANG['OPTIONS'] = 'Opciones';
$LANG['SEARCH'] = 'Buscar';
$LANG['DISPLAY_SYNONYMS'] = 'Mostrar Sinónimos';
$LANG['COMMON'] = 'Nombres Comunes';
$LANG['SYNON'] = 'Sinónimos';
$LANG['FILTER'] = 'Filtro';
$LANG['OGCHECK'] = 'Listado de Comprobación Original';
$LANG['NOTESVOUC'] = 'Notas &amp; Vouchers';
$LANG['TAXONAUTHOR'] = 'Autores del Taxón';
$LANG['TAXONABC'] = 'Mostrar Taxa Alfabéticamente';
...
$LANG['VOUCHER_MAPPING'] = 'Mapeo de Vouchers';
$LANG['BATCH_LOAD_SPREADSHEET'] = 'Subir hoja de cálculo';
$LANG['VOUCHERS_SIMPLE_MAP'] = 'Mostrar Vouchers en un Mapa Simple';
$LANG['SIMPLE_MAP'] = 'Mapa Sencillo';
...
$LANG['PAGE'] = 'Página';
$LANG['OF'] = 'de';
$LANG['CHECKLIST'] = 'Listado de Comprobación';
...
$LANG['LINKED_IMG'] = 'sólo imágenes de vouchers vinculados';
